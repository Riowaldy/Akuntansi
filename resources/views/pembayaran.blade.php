...
<div class="main-content" id="main-pembayaran" style="display:none;">
    <section class="section">
        <div class="section-header">
          <h1>Pembayaran</h1>
          <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><i class="fas fa-money-check-alt" style="margin: 2px 3px 0 0;"></i>Kas Bank</div>
            <div class="breadcrumb-item"><i class="fas fa-list" style="margin: 2px 3px 0 0;"></i>Pembayaran</div>
          </div>
        </div>
...
<div class="main-content" id="main-pembayaran-err" style="display:none;">
    <section class="section">
        <div class="section-header">
            <h1>404</h1>
        </div>
...
<script src="{{ asset('custom/js/pembayaran.js') }}"></script>
@endsection