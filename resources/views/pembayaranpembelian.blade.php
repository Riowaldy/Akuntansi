...
<div class="main-content" id="main-pembayaranpembelian" style="display:none;">
    <section class="section">
        <div class="section-header">
          ...
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><i class="fas fa-list" style="margin: 2px 3px 0 0;"></i>Pembayaran Pembelian</div>
          </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Tabel Pembayaran Pembelian</h4>
                        </div>
                        <div class="card-body">
...
<div class="main-content" id="main-pembayaranpembelian-err" style="display:none;">
    <section class="section">
        <div class="section-header">
            <h1>404</h1>
        </div>
