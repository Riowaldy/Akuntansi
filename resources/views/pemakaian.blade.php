...
@section('content')
<div class="main-content" id="main-pemakaian">
    <section class="section">
        <div class="section-header">
          <h1>Pemakaian</h1>
          <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><i class="fas fa-box-open" style="margin: 2px 3px 0 0;"></i>Persediaan</div>
            <div class="breadcrumb-item"><i class="fas fa-list" style="margin: 2px 3px 0 0;"></i>Pemakaian</div>
          </div>
        </div>
...
<div class="main-content" id="main-pemakaian-err">
    <section class="section">
        <div class="section-header">
            <h1>404</h1>
        </div>
